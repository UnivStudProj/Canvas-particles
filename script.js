...
var particles = new Array(properties.particleCount);
...
class Particle {
    constructor() {
        ...
        this.velocityX = Math.random() - properties.particleMaxVelocity;
        this.velocityY = Math.random() - properties.particleMaxVelocity;
    }
